...
class InvoiceSession:
    ...
    def open(self) -> bool:
        ...
        try:
            ...
            resp = requests.post(
                f'{config.api_url}/api/v2/sessions/online',
                headers=headers,
                json=body
            )
    ...
    def send_invoice(self, invoice_xml: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            resp = requests.post(
                f'{config.api_url}/api/v2/sessions/online/{self.session_reference}/invoices',
                headers=headers,
                json=body
            )
    ...
    def close(self) -> bool:
        ...
        try:
            ...
            resp = requests.post(
                f'{config.api_url}/api/v2/sessions/online/{self.session_reference}/close',
                headers=headers,
                json=body
            )
