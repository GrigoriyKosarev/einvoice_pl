...
**ВАЖЛИВО**: Порядок полів у FaWiersz має бути строгий!

- `NrWierszaFa` - Номер рядку (1, 2, 3...)
- `P_7` - Назва товару/послуги [ОБОВ'ЯЗКОВЕ]
  - **Уникайте**: квадратних дужок `[]`, подвійних пробілів, пробілів в кінці
  - **Максимальна довжина**: залежить від версії схеми
- `P_8A` - Кількість (decimal)
- `P_8AJ` - Одиниця виміру (наприклад: "szt", "kg", "usł") **[ТІЛЬКИ ПОЛЬСЬКОЮ МОВОЮ]**
- `P_8B` - Сума без ПДВ [ОБОВ'ЯЗКОВЕ]
- `P_9A` - Сума з ПДВ [ОБОВ'ЯЗКОВЕ]
- `P_11` - Ставка ПДВ (23, 8, 5, 0)
- `P_12` - Сума ПДВ
